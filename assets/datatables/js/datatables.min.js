    ...
    e =
      (b.extend(a.prototype, {
            ...
            if (!e.never && !e.control)
              return (
                ...
                s[t] || (s[t] = r.column(t)),
                {
                  className: e.sClass,
                  columnIndex: t,
                  data: o.fastData(n, t, i.c.orthogonal),
                  hidden: s[t].visible() && !i.s.current[t],
                  rowIndex: n,
                  title: s[t].title(),
                }
              );
        ...
        _resize: function (n) {
          ...
          var c = this._columnsVisibility(o),
        ...
        _setHeaderVis: function (n, i, s) {
          var r = this,
            o = i ? '' : 'none';
          s.forEach(function (e, t) {
            for (var n = 0; n < e.length; n++)
              if (e[n] && 1 < e[n].rowspan)
                for (var i = e[n].rowspan, r = 1; r < i; r++) s[t + r][n] = {};
          }),
    ...
    ? ((o = require('jquery')),
      ...
      'undefined' == typeof window
        ? (module.exports = function (e, d) {
            return (
              (e = e || window), (d = d || o(e)), n(e, d), t(d, e, e.document)
            );
          })
        : (n(window, o), (module.exports = t(o, window, window.document))))
      ...
      return (
        ...
        function (e, d, t, o) {
          if (u) {
            ...
            if (!1 === i) return !1;
            if (d) {
              if (!s.contains(l, p[0]) || e.index() !== p.data('dtr-row-idx'))
                return null;
              p.find('div.modal-body').empty().append(i);
            } else
              r &&
                r.header &&
                ((a = (n = p.find('div.modal-header')).find('button').detach()),
                n
                  .empty()
